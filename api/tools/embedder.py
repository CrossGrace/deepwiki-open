...
def get_embedder(is_local_ollama: bool = False, use_google_embedder: bool = False, embedder_type: str = None) -> adal.Embedder:
    ...
    Args:
        ...
        embedder_type: Direct specification of embedder type ('ollama', 'google', 'bedrock', 'bge_m3', 'openai')
    ...
    if embedder_type:
        ...
        elif embedder_type == 'bge_m3':
            embedder_config = configs["embedder_bge_m3"]

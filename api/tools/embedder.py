...
def get_embedder(is_local_ollama: bool = False, use_google_embedder: bool = False, embedder_type: str = None) -> adal.Embedder:
    ...
    Args:
        ...
        embedder_type: Direct specification of embedder type ('ollama', 'google', 'bedrock', 'enterprise_bge', 'openai')
    ...
    if embedder_type:
        ...
        elif embedder_type == 'enterprise_bge':
            embedder_config = configs["embedder_enterprise_bge"]
        ...
        if current_type == 'bedrock':
            ...
            embedder_config = configs["embedder_google"]
        elif current_type == 'enterprise_bge':
            embedder_config = configs["embedder_enterprise_bge"]
        else:
            embedder_config = configs["embedder"]
